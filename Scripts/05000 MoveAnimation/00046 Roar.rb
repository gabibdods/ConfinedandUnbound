...
animation_user = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'Roar', :animation], [:set_rect, 0, 0, 208, 192], [:zoom=, 1], [:set_origin, 104, 132])
...
Battle::MoveAnimation.register_specific_animation(:roar, :first_use, animation_target, animation_user)
