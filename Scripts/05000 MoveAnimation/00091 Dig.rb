ya = Yuki::Animation
# Dig 
# Only the second animation
animation_target = ya.wait(0.1)
animation_user = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'Dig', :animation], [:set_rect, 0, 0, 104, 192], [:zoom=, 1], [:set_origin, 52, 132])
...
main_t_anim.play_before(ya.se_play('moves/Dig'))
...
Battle::MoveAnimation.register_specific_animation(:dig, :first_use, animation_user, animation_target)
