...
animation_target = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'LeafBlade', :animation], [:set_rect, 0, 0, 208, 192], [:zoom=, 0.85], [:set_origin, 104, 132])
...
main_t_anim.play_before(ya.se_play('moves/LeafBlade'))
...
Battle::MoveAnimation.register_specific_animation(:leaf_blade, :first_use, animation_user, animation_target)
