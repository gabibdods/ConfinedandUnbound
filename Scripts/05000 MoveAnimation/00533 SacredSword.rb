...
animation_target = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'SacredSword', :animation], [:set_rect, 0, 0, 208, 192], [:zoom=, 0.85], [:set_origin, 104, 132])
...
main_t_anim.play_before(ya.se_play('moves/SacredSword'))
...
Battle::MoveAnimation.register_specific_animation(:sacred_sword, :first_use, animation_user, animation_target)
