...
animation_user = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'Disable', :animation], [:set_rect, 0, 0, 104, 192], [:zoom=, 0.25], [:set_origin, 0, 190])
...
main_t_anim.play_before(ya.se_play('moves/Disable'))
...
Battle::MoveAnimation.register_specific_animation(:disable, :first_use, animation_user, animation_target)
