...
animation_user.play_on_bank(0, ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'Taunt_0', :animation], [:set_rect, 0, 0, 104, 192], [:zoom=, 0.75], [:set_origin, 52, 132]))
animation_user.play_on_bank(1, ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'Taunt_1', :animation], [:set_rect, 0, 0, 104, 192], [:zoom=, 0.75], [:set_origin, 52, 132]))
...
main_t_anim.play_before(ya.se_play('moves/Taunt'))
...
Battle::MoveAnimation.register_specific_animation(:taunt, :first_use, animation_user, animation_target)
