...
animation_user = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'ScaryFace', :animation], [:set_rect, 0, 0, 208, 192], [:zoom=, 0.75], [:set_origin, 104, 132])
...
Battle::MoveAnimation.register_specific_animation(:scary_face, :first_use, animation_user, animation_target)
