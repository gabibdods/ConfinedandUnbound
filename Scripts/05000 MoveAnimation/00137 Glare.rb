...
animation_user = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'Glare', :animation], [:set_rect, 0, 0, 208, 192], [:zoom=, 0.75], [:set_origin, 104, 132])
...
Battle::MoveAnimation.register_specific_animation(:glare, :first_use, animation_user, animation_target)
