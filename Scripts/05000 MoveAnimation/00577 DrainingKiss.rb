...
animation_target = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'DrainingKiss', :animation], [:set_rect, 0, 0, 104, 192], [:zoom=, 1], [:set_origin, 52, 132])
...
Battle::MoveAnimation.register_specific_animation(:draining_kiss, :first_use, animation_user, animation_target)
