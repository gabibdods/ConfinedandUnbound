...
animation_target = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'RockThrow', :animation], [:set_rect, 0, 0, 208, 192], [:zoom=, 0.75], [:set_origin, 104, 132])
...
main_t_anim.play_before(ya.se_play('moves/RockThrow'))
...
Battle::MoveAnimation.register_specific_animation(:rock_throw, :first_use, animation_user, animation_target)
