...
animation_user = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'BugBuzz', :animation], [:set_rect, 0, 0, 104, 192], [:zoom=, 1.25], [:set_origin, 52, 132])
...
Battle::MoveAnimation.register_specific_animation(:bug_buzz, :first_use, animation_user, animation_target)
