...
animation_user = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'CalmMind', :animation], [:set_rect, 0, 0, 208, 192], [:zoom=, 0.75], [:set_origin, 104, 132])
...
main_t_anim.play_before(ya.se_play('moves/CalmMind'))
...
Battle::MoveAnimation.register_specific_animation(:calm_mind, :first_use, animation_user, animation_target)
