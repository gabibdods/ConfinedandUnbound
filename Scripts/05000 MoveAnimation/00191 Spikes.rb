...
animation_target = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'Spikes', :animation], [:set_rect, 0, 0, 104, 192], [:zoom=, 0.75], [:set_origin, 52, 132])
...
main_t_anim.play_before(ya.se_play('moves/Spikes'))
...
Battle::MoveAnimation.register_specific_animation(:spikes, :first_use, animation_user, animation_target)
