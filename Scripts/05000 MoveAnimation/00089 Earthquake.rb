...
animation_target = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'Earthquake', :animation], [:set_rect, 0, 0, 104, 192], [:zoom=, 1.25], [:set_origin, 52, 165])
...
main_t_anim.play_before(ya.se_play('moves/Earthquake'))
...
Battle::MoveAnimation.register_specific_animation(:earthquake, :first_use, animation_user, animation_target)
