...
animation_user = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'Lunge', :animation], [:set_rect, 0, 0, 104, 192], [:zoom=, 1], [:set_origin, 52, 132])
...
main_t_anim.play_before(ya.se_play('moves/Lunge'))
...
main_t_anim.play_before(ya.wait(0.45))
...
Battle::MoveAnimation.register_specific_animation(:lunge, :first_use, animation_user, animation_target)
