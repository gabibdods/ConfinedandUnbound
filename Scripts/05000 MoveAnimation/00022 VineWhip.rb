...
animation_target = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'VineWhip', :animation], [:set_rect, 0, 0, 104, 192], [:zoom=, 0.75], [:set_origin, 52, 132])
...
main_t_anim.play_before(ya.se_play('moves/VineWhip'))
