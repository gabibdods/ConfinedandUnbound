...
animation_user = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'FlameCharge', :animation], [:set_rect, 0, 0, 104, 192], [:zoom=, 1.25], [:set_origin, 52, 132])
...
main_t_anim.play_before(ya.se_play('moves/FlameCharge'))
...
main_t_anim.play_before(ya.wait(0.6))
...
Battle::MoveAnimation.register_specific_animation(:flame_charge, :first_use, animation_user, animation_target)
