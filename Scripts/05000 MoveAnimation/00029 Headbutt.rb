...
animation_target = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'Headbutt', :animation], [:set_rect, 0, 0, 104, 192], [:zoom=, 1], [:set_origin, 52, 132])
...
main_t_anim.play_before(ya.se_play('moves/Headbutt'))
...
Battle::MoveAnimation.register_specific_animation(:headbutt, :first_use, animation_user, animation_target)
