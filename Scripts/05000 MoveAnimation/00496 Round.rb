...
animation_user = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'Round', :animation], [:set_rect, 0, 0, 208, 192], [:zoom=, 0.75], [:set_origin, 104, 132])
...
main_t_anim.play_before(ya.se_play('moves/Round'))
...
Battle::MoveAnimation.register_specific_animation(:round, :first_use, animation_target, animation_user)
