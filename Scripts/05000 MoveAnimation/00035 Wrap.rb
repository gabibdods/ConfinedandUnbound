...
animation_target = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'Wrap', :animation], [:set_rect, 0, 0, 104, 192], [:zoom=, 0.5], [:set_origin, 52, 132])
...
main_t_anim.play_before(ya.se_play('moves/Wrap'))
...
Battle::MoveAnimation.register_specific_animation(:wrap, :first_use, animation_user, animation_target)
