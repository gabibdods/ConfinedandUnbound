...
animation_user = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'LavaPlume', :animation], [:set_rect, 0, 0, 104, 192], [:zoom=, 2], [:set_origin, 52, 132])
...
main_t_anim.play_before(ya.se_play('moves/LavaPlume'))
...
Battle::MoveAnimation.register_specific_animation(:lava_plume, :first_use, animation_user, animation_target)
