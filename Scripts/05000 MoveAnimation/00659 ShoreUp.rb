...
animation_user = ya.create_sprite(:viewport, :sprite, Sprite, nil, [:load, 'ShoreUp', :animation], [:set_rect, 0, 0, 104, 192], [:zoom=, 0.75], [:set_origin, 52, 142])
...
main_t_anim.play_before(ya.se_play('moves/ShoreUp'))
...
Battle::MoveAnimation.register_specific_animation(:shore_up, :first_use, animation_user, animation_target)
