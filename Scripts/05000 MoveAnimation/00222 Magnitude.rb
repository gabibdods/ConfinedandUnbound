...
main_t_anim.play_before(ya.se_play('moves/Magnitude'))
...
Battle::MoveAnimation.register_specific_animation(:magnitude, :first_use, animation_user, animation_target)
