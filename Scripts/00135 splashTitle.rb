class Scene_Title
    ...
    def create_splash_animation(se_filename = nil)
      if se_filename
        ...
        @splash_animation.play_before(Yuki::Animation.opacity_change(0.4, @background, 255, 255))
      else
        @splash_animation = Yuki::Animation.opacity_change(0.4, @background, 255, 255)
      end
