...
class PokemonPokegear_Scene
  USE_PM_AM = PokemonPokegear_Scene::USE_PM_AM # Make it false to use European format
  SHOW_SECONDS = PokemonPokegear_Scene::SHOW_SECONDS # Make it false to won't show the seconds
  SHOW_WEEKDAY_NAME = PokemonPokegear_Scene::SHOW_WEEKDAY_NAME # Make it false to won't show weekday name
